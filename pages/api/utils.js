...
export default async function handler(req, res) {
    ...
    if (req.body.task === 'generate_content') {
     ...
     const s3 = new AWS.S3({
      ...
      const videoURL = 'https://bucketkikus.s3.eu-west-3.amazonaws.com/VideoTangerInstalado.mp4'
      const thumbnailURL = 'https://bucketkikus.s3.eu-west-3.amazonaws.com/women.jpeg'
